...
create () {
  ...
  setup_script="https://raw.githubusercontent.com/serdarozsoy/gcp_create/master/setup-gce.sh?__ts=$RANDOM"
  gcloud compute --project $DEVSHELL_PROJECT_ID ssh --zone $current_zone "fastai-boot-1"
